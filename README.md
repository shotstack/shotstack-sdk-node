...
Method | Description | Required
:--- | :--- | :---: 
setAsset($asset) | The type of asset to display for the duration of this Clip. Value must be one of: <ul><li>[\Shotstack\Client\Model\VideoAsset](#videoasset)</li><li>[\Shotstack\Client\Model\ImageAsset](#imageasset)</li><li>[\Shotstack\Client\Model\TitleAsset](#titleasset)</li><li>[\Shotstack\Client\Model\HtmlAsset](#htmlasset)</li><li>[\Shotstack\Client\Model\AudioAsset](#audioasset)</li><li>[\Shotstack\Client\Model\LumaAsset](#lumaasset)</li></ul>  | Y

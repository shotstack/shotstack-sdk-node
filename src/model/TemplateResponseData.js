 ...
 * @version 0.2.9
 */
var TemplateResponseData = /*#__PURE__*/function () {
  /**
   ...
   */
  function TemplateResponseData(message, id) {
    _classCallCheck(this, TemplateResponseData);
   ...
   */
  return _createClass(TemplateResponseData, [{
    key: "getMessage",
    value:
    /**
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(TemplateResponseData.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = TemplateResponseData;
 ...
 * @version 0.2.9
 */
var ShotstackTextGeneratorOptions = /*#__PURE__*/function () {
  /**
   ...
   */
  function ShotstackTextGeneratorOptions(type, prompt) {
    _classCallCheck(this, ShotstackTextGeneratorOptions);
   ...
   */
  return _createClass(ShotstackTextGeneratorOptions, [{
    key: "getType",
    value:
    /**
    ...
    key: "initialize",
    value: function initialize(obj, type, prompt) {
    ...
    value: function validateJSON(data) {
      ...
      var _iterator = _createForOfIteratorHelper(ShotstackTextGeneratorOptions.RequiredProperties),
        _step;
      try {
...
var _default = exports["default"] = ShotstackTextGeneratorOptions;
...
var _SkewTransformationX = _interopRequireDefault(require("./SkewTransformationX"));
var _SkewTransformationY = _interopRequireDefault(require("./SkewTransformationY"));
...
var SkewTransformation = /*#__PURE__*/function () {
  ...
  return _createClass(SkewTransformation, [{
    ...
    value:
    /**
         * @return {module:model/SkewTransformationX}
         */
    function getX() {
      return this.x;
    }
    ...
    /**
     * @param {module:model/SkewTransformationX} x
     */
  }, {
    key: "setX",
    ...
    /**
         * @return {module:model/SkewTransformationY}
         */
  }, {
    key: "getY",
    value: function getY() {
    ...
    /**
     * @param {module:model/SkewTransformationY} y
     */
  }, {
    key: "setY",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('x')) {
          obj['x'] = _SkewTransformationX["default"].constructFromObject(data['x']);
        }
        if (data.hasOwnProperty('y')) {
          obj['y'] = _SkewTransformationY["default"].constructFromObject(data['y']);
        }
      }
      return obj;
    }
    ...
    value: function validateJSON(data) {
      ...
      if (data['x']) {
        // data not null
        _SkewTransformationX["default"].validateJSON(data['x']);
      }
      // validate the optional field `y`
      if (data['y']) {
        // data not null
        _SkewTransformationY["default"].validateJSON(data['y']);
      }
      return true;
    }
  }]);
...
/**
 * @member {module:model/SkewTransformationX} x
 */
SkewTransformation.prototype['x'] = undefined;

/**
 * @member {module:model/SkewTransformationY} y
 */

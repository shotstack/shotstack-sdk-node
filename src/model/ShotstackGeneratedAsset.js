...
class ShotstackGeneratedAsset {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('options')) {
                obj['options'] = ShotstackGeneratedAssetOptions.constructFromObject(data['options']);
            }
        }
        return obj;
    }
    ...
    static validateJSON(data) {
        ...
        for (const property of ShotstackGeneratedAsset.RequiredProperties) {
        ...
        if (data['options']) { // data not null
          ShotstackGeneratedAssetOptions.validateJSON(data['options']);
        }
...
export default ShotstackGeneratedAsset;

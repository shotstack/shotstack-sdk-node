...
export type AudioassetAudioAsset = {
    ...
    model?: string;
    /**
     * Target duration in milliseconds for generated music (3,000–600,000). Only meaningful when `prompt` is set and the model is a music generator (e.g. `fal/elevenlabs-music`).
     */
    musicLengthMs?: number;
    /**
     * Set to `true` to force instrumental music (no vocals). Only meaningful for music generation models.
     */
...
export type ImageassetImageAsset = {
    ...
    model?: string;
    /**
     * Output resolution tier for supported image generation models. `1K` (default), `2K`, or `4K`. Only meaningful when `prompt` is set.
     */
    resolution?: '1K' | '2K' | '4K';
    /**
     * Aspect ratio for the generated image. Only meaningful when `prompt` is set and the model supports it.
     */

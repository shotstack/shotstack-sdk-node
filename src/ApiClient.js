...
var ApiClient = /*#__PURE__*/function () {
   ...
   */
  function ApiClient() {
    var basePath = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'https://api.shotstack.io/edit/v1';
    _classCallCheck(this, ApiClient);
    /**
     * The base URL against which to resolve every API call's (relative) path.
     * @type {String}
     * @default https://api.shotstack.io/edit/v1
     */
     ...
     */
    this.defaultHeaders = {
      'User-Agent': 'OpenAPI-Generator/0.2.9/Javascript'
    };
